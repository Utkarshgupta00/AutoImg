...
const FormField = ({
  value,labelName, type, name, placeholder, handleChange, isSurpriseMe, handleSurpriseMe
}) => {
  return (
    <div>
       ...
       > 
...

        {
          isSurpriseMe && (
            ...
            className='px-2 py-2 text-xs font-semibold bg-blue-400 rounded-lg text-white'
            >
              Surprise Me
            </button>
          )
